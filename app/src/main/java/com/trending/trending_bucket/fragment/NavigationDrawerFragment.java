...
import com.trending.trending_bucket.activity.ChangePasswordActivity;
import com.trending.trending_bucket.activity.ProfileUpdateActivity;
import com.trending.trending_bucket.activity.LoginActivity;
import com.trending.trending_bucket.activity.RegistrationActivity;
import com.trending.trending_bucket.adapters.NavigationAdapter;


import static com.trending.trending_bucket.util.constants.*;
import static com.trending.trending_bucket.util.utilMethods.browseUrl;
import static com.trending.trending_bucket.util.utilMethods.isUserSignedIn;
import static com.trending.trending_bucket.util.utilMethods.showExitDialog;
import static com.trending.trending_bucket.util.utilMethods.isDeviceCallSupported;
import static com.trending.trending_bucket.util.utilMethods.showHotLineCallDialog;
import static com.trending.trending_bucket.util.utilMethods.mailTo;
...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (!isUserSignedIn(getActivity())){
            ...
            rootView.findViewById(R.id.btnCart).setVisibility(View.GONE);
            rootView.findViewById(R.id.btnOrders).setVisibility(View.GONE);}
        ...
        rootView.findViewById(R.id.btnCart).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getActivity(), Cartz.class));
                closeDrawer();
            }
        });

        rootView.findViewById(R.id.btnOrders).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                    ...
                    if (groupPosition == 1) {
                        ...
                        if(childPosition == 1){
                            if (isDeviceCallSupported(getActivity())) {
                                showHotLineCallDialog(getActivity(), getResources().getString(R.string.hotline_call_heading),
